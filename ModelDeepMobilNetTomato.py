...
# ============================================================================
# ============================================================================
# ARQUITECTURA DEEPLABV3 + MOBILENETV2 (Optimizado para Borde/Edge)
# ============================================================================

def ASPP_block(tensor):
    """Bloque Atrous Spatial Pyramid Pooling optimizado"""
    dims = tensor.shape
    ...
    # 2. Atrous Convolutions (Dilataciones ajustadas para MobileNet)
...
def build_deeplab_mobilenet(input_shape=(256, 256, 3), num_classes=5):
    # Backbone ligero
    base_model = tf.keras.applications.MobileNetV2(
        input_shape=input_shape, include_top=False, weights='imagenet'
    )
    
    # Extracción de características (Capa con stride 16 para el ASPP)
    # En MobileNetV2 de 256x256, 'block_13_expand_relu' suele ser 16x16
    ds_out = base_model.get_layer("block_13_expand_relu").output 
    
    # --- Rama de Segmentación (DeepLab Head) ---
    ...
    # Salida final de máscara 256x256
...
history_df.to_csv("history_deeplabv3_mobilenet2.csv", index=False)
