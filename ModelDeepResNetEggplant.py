...
Modelo Deep and Resnet para Segmentación y Clasificación de Eggplant
@author: dkpin
"""
import os
import sys
...
# 1. Aumentar el límite por si acaso (el error de recursión es persistente)
...
# ============================================================================
# 1. MÓDULO ASPP (Atrous Spatial Pyramid Pooling)
# ============================================================================
def ASPP(inputs):
    shape = inputs.shape
    # Pool de imagen global
    ...
    # Convoluciones Atrous (Dilatadas) con diferentes ratios
    b0 = layers.Conv2D(256, 1, padding="same", use_bias=False)(inputs)
    b0 = layers.BatchNormalization()(b0)
    b0 = layers.Activation("relu")(b0)

    # Ratio 6
    b1 = layers.Conv2D(256, 3, dilation_rate=6, padding="same", use_bias=False)(inputs)
    b1 = layers.BatchNormalization()(b1)
    b1 = layers.Activation("relu")(b1)

    # Ratio 12
    b2 = layers.Conv2D(256, 3, dilation_rate=12, padding="same", use_bias=False)(inputs)
    b2 = layers.BatchNormalization()(b2)
    b2 = layers.Activation("relu")(b2)

    # Concatenar todo
    x = layers.Concatenate()([pool, b0, b1, b2])
...
# ============================================================================
# 2. ARQUITECTURA DEEPLABV3+ COMPLETA
# ============================================================================
def build_deeplabv3_plus_resnet50(input_shape=(256, 256, 3), num_classes_seg=5, num_classes_clf=5):
    inputs = layers.Input(shape=input_shape, name="image_input")
    
    # Encoder: ResNet50
    base_model = ResNet50(input_tensor=inputs, include_top=False, weights="imagenet")
    
    # Extraemos características de bajo nivel (para el Decoder)
    # En ResNet50, conv2_block3_out es 64x64
    low_level_features = base_model.get_layer("conv2_block3_out").output
    
    # Extraemos la salida del Encoder (para el ASPP)
    # Usamos conv4_block6_out para mantener una resolución de 16x16 (stride 16)
    ...
    # --- DECODER DEEPLAB ---
    # 1. Subir resolución de las características del ASPP (16x16 -> 64x64)
    x = layers.UpSampling2D(size=(4, 4), interpolation="bilinear")(x)
    
    # 2. Procesar características de bajo nivel
    ...
    x = layers.Conv2D(256, 3, padding="same", activation="relu", use_bias=False)(x)
    x = layers.BatchNormalization()(x)
    x = layers.Conv2D(256, 3, padding="same", activation="relu", use_bias=False)(x)
    x = layers.BatchNormalization()(x)
    
    # 4. Upsampling final (64x64 -> 256x256)
    x = layers.UpSampling2D(size=(4, 4), interpolation="bilinear")(x)
...
# 3. COMPILACIÓN
# ============================================================================
model = build_deeplabv3_plus_resnet50()
...
history_df.to_csv("history_deep_resnet_eggplant.csv", index=False)
...
model.save("EggplanDeepResNet.keras")
...
tflite_path  = "EggplanDeepResNet.tflite"
with open(tflite_path, "wb") as f:
    f.write(tflite_model)

print("✅ Modelo TFLite guardado: EggplanDeepResNet.tflite")
